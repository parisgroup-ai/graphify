...
fn now_iso8601() -> String {
    // RFC 3339 / ISO 8601 in UTC to the second. Avoid pulling in `chrono` just
    // for this — the wire format is `YYYY-MM-DDTHH:MM:SSZ`.
...
fn format_epoch_seconds_utc(secs: u64) -> String {
    // Civil date conversion (Howard Hinnant's algorithm). Sufficient for 1970+.
...
mod tests {
    ...
    #[test]
    fn format_epoch_seconds_utc_matches_known_values() {
